      ...
      <div className="container mx-auto px-6 py-4">
        <div className="flex items-center justify-between">
          ...
          <div className="hidden md:flex gap-8">
            <a href="#features" className="text-gray-600 hover:text-gray-400 transition-colors">Features</a>
            <a href="#how-it-works" className="text-gray-600 hover:text-gray-400 transition-colors">How it Works</a>
            <a href="#pricing" className="text-gray-600 hover:text-gray-400 transition-colors">Pricing</a>
            <a href="#testimonials" className="text-gray-600 hover:text-gray-400 transition-colors">Testimonials</a>
          </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <motion.button 
              ...
              whileTap={{ scale: 0.98 }}
              className="hidden md:block px-4 py-2 text-gray-600 hover:text-gray-400 transition-colors"
            >
              Login
            </motion.button>
            </a>
